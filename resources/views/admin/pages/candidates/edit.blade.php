                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('full_name') is-invalid @enderror"
                                        id="full_name" name="full_name" value="{{ old('full_name', $candidate->full_name) }}">
                                    @error('full_name')
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('desired_position') is-invalid @enderror"
                                        id="desired_position" name="desired_position" value="{{ old('desired_position', $candidate->desired_position) }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('outlet_department') is-invalid @enderror"
                                        id="outlet_department" name="outlet_department" value="{{ old('outlet_department', $candidate->outlet_department) }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('employment_type') is-invalid @enderror" id="employment_type" name="employment_type">
                                        ...
                                        <option value="full-time" {{ old('employment_type', $candidate->employment_type) == 'full-time' ? 'selected' : '' }}>Toàn thời gian</option>
                                        <option value="casual-labor" {{ old('employment_type', $candidate->employment_type) == 'casual-labor' ? 'selected' : '' }}>Bán thời gian</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('department_id') is-invalid @enderror" id="department_id" name="department_id">
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}" {{ old('department_id', $candidate->department_id) == $department->id ? 'selected' : '' }}>
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
