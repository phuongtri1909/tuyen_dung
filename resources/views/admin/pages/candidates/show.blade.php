            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('generate.word', $candidate->id) }}" class="btn btn-info btn-sm" title="Xuất Word">
                                <i class="fa-solid fa-file-word me-1"></i> Xuất Word
                            </a>
                            
                            @if(auth()->user()->role != 'admin')
                                <a target="_blank" href="{{ route('candidates.interview',$candidate->id) }}" class="btn btn-primary btn-sm" title="Phỏng vấn">
                ...
                <div class="card-body pt-4 p-3">
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-{{ $candidate->employment_type == 'full-time' ? 'primary' : 'info' }}">
                                                    ...
                                                    <td>
                                                        @if($candidate->cv)
                                                            <div>
                                                                ...
                                                                <a href="{{ asset('storage/' . $candidate->cv) }}" download class="btn btn-sm btn-info">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card interview-info-card">
                                <div class="card-body">
                                    <h6 class="text-uppercase text-primary font-weight-bolder mb-3">Yêu cầu cơ bản cho vị trí</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item d-flex justify-content-between px-0">
                                                    ...
                                                    <span class="fw-bold">{{ $candidate->notice_days ?? 'N/A' }} ngày</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card bg-light">
                                                <div class="card-body py-2">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <strong>{{ number_format($candidate->min_salary ?? 0) }} VNĐ</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card interview-info-card">
                                <div class="card-body">
                                    <h6 class="text-uppercase text-primary font-weight-bolder mb-3">Đánh giá chi tiết (1-10)</h6>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table evaluation-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><strong>1. Appearance & Attire</strong><br><small class="text-muted">Dung mạo & Trang phục</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['appearance']))
                                                            <span class="rating-value">{{ $evaluations['hr']['appearance'] }}</span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['appearance']))
                                                            <span class="rating-value">{{ $evaluations['lm']['appearance'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['appearance']))
                                                            <span class="rating-value">{{ $evaluations['final']['appearance'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>2. English</strong><br><small class="text-muted">Tiếng Anh</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['english']))
                                                            <span class="rating-value">{{ $evaluations['hr']['english'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['english']))
                                                            <span class="rating-value">{{ $evaluations['lm']['english'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['english']))
                                                            <span class="rating-value">{{ $evaluations['final']['english'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>3. Chinese</strong><br><small class="text-muted">Tiếng Trung</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['chinese']))
                                                            <span class="rating-value">{{ $evaluations['hr']['chinese'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['chinese']))
                                                            <span class="rating-value">{{ $evaluations['lm']['chinese'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['chinese']))
                                                            <span class="rating-value">{{ $evaluations['final']['chinese'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>4. Japanese</strong><br><small class="text-muted">Tiếng Nhật</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['japanese']))
                                                            <span class="rating-value">{{ $evaluations['hr']['japanese'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['japanese']))
                                                            <span class="rating-value">{{ $evaluations['lm']['japanese'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['japanese']))
                                                            <span class="rating-value">{{ $evaluations['final']['japanese'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>5. Computer skills</strong><br><small class="text-muted">Kỹ năng vi tính</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['computer']))
                                                            <span class="rating-value">{{ $evaluations['hr']['computer'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['computer']))
                                                            <span class="rating-value">{{ $evaluations['lm']['computer'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['computer']))
                                                            <span class="rating-value">{{ $evaluations['final']['computer'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>6. Behavior during interview</strong><br><small class="text-muted">Ứng xử trong phỏng vấn</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['behavior']))
                                                            <span class="rating-value">{{ $evaluations['hr']['behavior'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['behavior']))
                                                            <span class="rating-value">{{ $evaluations['lm']['behavior'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['behavior']))
                                                            <span class="rating-value">{{ $evaluations['final']['behavior'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>7. Characteristics</strong><br><small class="text-muted">Tính cách</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['characteristics']))
                                                            <span class="rating-value">{{ $evaluations['hr']['characteristics'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['characteristics']))
                                                            <span class="rating-value">{{ $evaluations['lm']['characteristics'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['characteristics']))
                                                            <span class="rating-value">{{ $evaluations['final']['characteristics'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>8. Communication skills</strong><br><small class="text-muted">Kỹ năng giao tiếp</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['communication']))
                                                            <span class="rating-value">{{ $evaluations['hr']['communication'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['communication']))
                                                            <span class="rating-value">{{ $evaluations['lm']['communication'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['communication']))
                                                            <span class="rating-value">{{ $evaluations['final']['communication'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>9. Motivation</strong><br><small class="text-muted">Động lực ứng tuyển</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['motivation']))
                                                            <span class="rating-value">{{ $evaluations['hr']['motivation'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['motivation']))
                                                            <span class="rating-value">{{ $evaluations['lm']['motivation'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['motivation']))
                                                            <span class="rating-value">{{ $evaluations['final']['motivation'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>10. Experience from previous jobs</strong><br><small class="text-muted">Kinh nghiệm từ công việc trước đây</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['experience']))
                                                            <span class="rating-value">{{ $evaluations['hr']['experience'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['experience']))
                                                            <span class="rating-value">{{ $evaluations['lm']['experience'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['experience']))
                                                            <span class="rating-value">{{ $evaluations['final']['experience'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>11. Customer handling experience</strong><br><small class="text-muted">Kinh nghiệm giải quyết vấn đề khách hàng</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['customer']))
                                                            <span class="rating-value">{{ $evaluations['hr']['customer'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['customer']))
                                                            <span class="rating-value">{{ $evaluations['lm']['customer'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['customer']))
                                                            <span class="rating-value">{{ $evaluations['final']['customer'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>12. Flexibility</strong><br><small class="text-muted">Sự linh hoạt, mềm mỏng trong công việc</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['flexibility']))
                                                            <span class="rating-value">{{ $evaluations['hr']['flexibility'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['flexibility']))
                                                            <span class="rating-value">{{ $evaluations['lm']['flexibility'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['flexibility']))
                                                            <span class="rating-value">{{ $evaluations['final']['flexibility'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>13. Teamwork</strong><br><small class="text-muted">Tinh thần tập thể</small></td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['hr']['teamwork']))
                                                            <span class="rating-value">{{ $evaluations['hr']['teamwork'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['lm']['teamwork']))
                                                            <span class="rating-value">{{ $evaluations['lm']['teamwork'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if(isset($evaluations['final']['teamwork']))
                                                            <span class="rating-value">{{ $evaluations['final']['teamwork'] }}</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card interview-info-card">
                                <div class="card-body">
                                    <h6 class="text-uppercase text-primary font-weight-bolder mb-3">Đề xuất của người phỏng vấn</h6>
                                    ...
                                    <div class="recommendation-box">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="mb-2">{{ $recommendations['hr']['action'] ?? 'Không có đề xuất' }}</p>
                                            </div>
                                            <div class="col-md-4">
                                                @if(isset($recommendations['hr']['propose_next_step']))
                                                    ...
                                                    @elseif($recommendations['hr']['propose_next_step'] == 'other_position')
                                                        ...
                                                        @if(isset($recommendations['hr']['other_position_detail']))
                                                            <p class="small text-muted mt-1">{{ $recommendations['hr']['other_position_detail'] }}</p>
                                                        @endif
                                                    @endif
                                                @else
                                    ...
                                    <div class="recommendation-box">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="mb-2">{{ $recommendations['lm']['action'] ?? 'Không có đề xuất' }}</p>
                                            </div>
                                            <div class="col-md-4">
                                                @if(isset($recommendations['lm']['propose_next_step']))
                                                    ...
                                                    @elseif($recommendations['lm']['propose_next_step'] == 'other_position')
                                                        ...
                                                        @if(isset($recommendations['lm']['other_position_detail']))
                                                            <p class="small text-muted mt-1">{{ $recommendations['lm']['other_position_detail'] }}</p>
                                                        @endif
                                                    @endif
                                                @else
                                                    <span class="badge bg-secondary">Chưa có đề xuất</span>
                                    ...
                                    <div class="recommendation-box">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="mb-2">{{ $recommendations['final']['action'] ?? 'Không có đề xuất' }}</p>
                                            </div>
                                            <div class="col-md-4">
                                                @if(isset($recommendations['final']['propose_next_step']))
                                                    ...
                                                    @elseif($recommendations['final']['propose_next_step'] == 'other_position')
                                                        ...
                                                        @if(isset($recommendations['final']['other_position_detail']))
                                                            <p class="small text-muted mt-1">{{ $recommendations['final']['other_position_detail'] }}</p>
                                                        @endif
                                                    @endif
                                                @else
                                                    <span class="badge bg-secondary">Chưa có đề xuất</span>
                                    ...
                                    <div class="mt-3">
                                        <h6 class="text-uppercase font-weight-bolder">Phản hồi về thông tin tham khảo</h6>
                            ...
                            <div class="card interview-info-card">
                                <div class="card-body">
                                    ...
                                    <div class="cv-preview-container">
                                        <object data="{{ asset('storage/' . $candidate->cv) }}" type="application/pdf" width="100%" height="100%">
                                            <p>Trình duyệt của bạn không hỗ trợ nhúng PDF. <a href="{{ asset('storage/' . $candidate->cv) }}" target="_blank">Nhấn vào đây</a> để mở PDF trong tab mới.</p>
                                        </object>
                                    </div>
                                </div>
                            </div>
