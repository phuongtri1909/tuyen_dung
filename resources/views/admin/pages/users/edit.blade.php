        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Sửa nhân viên: {{ $user->name }}</h5>
                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('role') is-invalid @enderror" id="role" name="role">
                                        ...
                                        <option value="hr" {{ old('role', $user->role) == 'hr' ? 'selected' : '' }}>Nhân sự (HR)</option>
                                        <option value="lm" {{ old('role', $user->role) == 'lm' ? 'selected' : '' }}>Quản lý (LM)</option>
                                        <option value="final" {{ old('role', $user->role) == 'final' ? 'selected' : '' }}>Quyết định cuối cùng (Final)</option>
                                    </select>
                                    @error('role')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
